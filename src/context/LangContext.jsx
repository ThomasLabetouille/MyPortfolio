...
export const projectsData = {
  ...
  en: {
    ...
    "game-animation-sample": {
      title: "GameAnimationSample",
      subtitle: "A UE5 tooling suite: blockout, scripted Behavior Trees, agent evaluation, local AI assistant — Personal project",
      type: "Tooling / AI",
      role: "Solo developer",
      description: "Four Unreal Engine 5.8 plugins and an evaluation harness, held together by one constraint kept from beginning to end: nothing is driven through the screen. Everything — building a level, wiring a Behavior Tree, playing a session to check a behaviour — has to go through script. That constraint is what forced the missing tools to be written, then verified against what they claim to do, and finally what forced checking that the agent using them follows the project's own rules. The project can also be driven in natural language by an AI assistant running entirely locally on the graphics card, with no account or subscription.",
      highlights: [
