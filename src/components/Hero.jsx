  ...
  return (
    <>
      <style>{`
        ...
        .hero-grid { position: absolute; inset: 0; background-image: linear-gradient(rgba(234,214,175,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(234,214,175,0.03) 1px, transparent 1px); background-size: 60px 60px; --mx: 50%; --my: 50%; mask-image: radial-gradient(ellipse 60% 60% at var(--mx) var(--my), black 0%, transparent 100%); -webkit-mask-image: radial-gradient(ellipse 60% 60% at var(--mx) var(--my), black 0%, transparent 100%); }
        .hero-glow { position: absolute; width: 600px; height: 600px; background: radial-gradient(circle, rgba(234,214,175,0.07) 0%, transparent 70%); top: 50%; left: 50%; transform: translate(-50%,-50%); pointer-events: none; }
        .hero-glow2 { position: absolute; width: 400px; height: 400px; background: radial-gradient(circle, transparent 0%, transparent 70%); top: 20%; right: 10%; pointer-events: none; }
        .hero-content { position: relative; z-index: 1; max-width: 900px; margin: 0 auto; width: 100%; padding-top: 64px; }
        .hero-tag { display: inline-flex; align-items: center; gap: .6rem; font-family: var(--font-mono); font-size: .75rem; color: var(--accent); letter-spacing: .1em; margin-bottom: 1.5rem; border: 1px solid rgba(234,214,175,0.2); padding: .35rem .9rem; border-radius: 2px; background: rgba(234,214,175,0.05); }
        ...
        .hero-name { font-size: clamp(2.6rem, 6vw, 4.6rem); font-weight: 600; line-height: 1.05; letter-spacing: -.01em; margin-bottom: .5rem; }
        .hero-name-accent { color: var(--text); }
        ...
        .hero-desc { font-size: 1.1rem; color: var(--text2); line-height: 1.7; max-width: 600px; margin-bottom: 2.5rem; font-family: var(--font-mono); font-weight: 300; }
        .hero-btns { display: flex; gap: 1rem; flex-wrap: wrap; }
        .btn-primary { background: var(--accent); color: var(--bg); border: none; padding: .85rem 2rem; font-family: var(--font-display); font-size: .8rem; letter-spacing: .12em; text-transform: uppercase; font-weight: 700; transition: transform .15s, box-shadow .15s; border-radius: 3px; cursor: pointer; }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0,0,0,0.35); }
        .btn-secondary { background: transparent; color: var(--text); border: 1px solid var(--border2); border-radius: 3px; padding: .85rem 2rem; font-family: var(--font-display); font-size: .8rem; letter-spacing: .12em; text-transform: uppercase; transition: border-color .2s, color .2s; cursor: pointer; }
        ...
        .stat-num { font-size: 1.5rem; font-weight: 600; color: var(--accent); line-height: 1.1; white-space: nowrap; }
